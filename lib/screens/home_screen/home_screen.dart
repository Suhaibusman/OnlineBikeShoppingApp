...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              //       child: Stack(
              //         clipBehavior: Clip.none, // This allows for overflow to be visible
              //         children: [
              //           ProductTypeWidget(
              //             index: 0,
              ...
              //
              //
              //           // You can add more Positioned widgets here if needed for additional containers
              //         ],
              //       ),
              //     ),
              //   ),
      ...
      //         right: 0,
      //         left: 0,
      //         child: Image.asset(ImageConstant.blueBackgroundImage)),
      //
      //   ],
      // ),
